...
musicTest = stats.ttest_ind(
    musicGroup, noMusicGroup, equal_var=False)

astronomyTest = stats.ttest_ind(
    lowAstronomyGroup, highAstronomyGroup, equal_var=False)

combinedGroupTest = stats.ttest_ind(
    highAstronomyWithMusicGroup, lowAstronomyNoMusicGroup, equal_var=False)
...
musicCohensD = computeCohensD(
    musicGroup,
    noMusicGroup)

astronomyCohensD = computeCohensD(
    lowAstronomyGroup,
    highAstronomyGroup)

combinedGroupCohensD = computeCohensD(
...
print("High Astronomy Knowledge + Music Background vs Low Astronomy Knowledge + No Music Background")
print("nHighAstronomyWithMusic =", len(highAstronomyWithMusicGroup))
print("nLowAstronomyNoMusic =", len(lowAstronomyNoMusicGroup))
print("meanHighAstronomyWithMusic =", highAstronomyWithMusicGroup.mean())
print("meanLowAstronomyNoMusic =", lowAstronomyNoMusicGroup.mean())
print("sdHighAstronomyWithMusic =", highAstronomyWithMusicGroup.std())
print("sdLowAstronomyNoMusic =", lowAstronomyNoMusicGroup.std())
print("tStat =", combinedGroupTest.statistic)
print("pValue =", combinedGroupTest.pvalue)
print("cohensD =", combinedGroupCohensD)