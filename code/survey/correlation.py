...
# === 2. Define column names (from your CSV) ===
...
# Likert mapping (adjust if wording differs slightly)
likert_map = {
    "Strongly disagree": 1,
    "Disagree": 2,
    "Neutral": 3,
...
# === 4. Convert perception (before/after) ===
...
# === 5. Accuracy ===
# Your CSV already has "Score" (percentage)
